...
namespace DCC\DashboardDownload;
 ...
 * @package DCC\DashboardReport
 */
class DashboardDownload extends AbstractExternalModule
{
    ...
    {
        // Default is to show the events in rows.
        return '<h4>Display events in...' .
            '<a class="btn btn-warning pr-4 mx-3" href="' . $this->getUrl('index.php') . '&type=rows">Rows</a>' .
            ' or ' .
            '<a class="btn btn-warning pr-4 mx-3" href="' . $this->getUrl('index.php') . '&type=simplified">Rows Simplified</a>' .
            ' or ' .
            '<a class="btn btn-warning pr-4 mx-3" href="' . $this->getUrl('index.php') . '&type=columns">Columns</a>' .
            '</h4>';
    }
